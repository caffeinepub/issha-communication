      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <motion.div
            ...
            className="relative rounded-3xl overflow-hidden border border-white/15 h-64 flex items-center justify-center bg-white/5 backdrop-blur-sm"
          >
            <div
            ...
            <div className="relative z-10 text-center">
              <div
                ...
                style={{
                  background:
                    "linear-gradient(135deg, oklch(var(--c-blue) / 0.4), oklch(var(--c-purple) / 0.4))",
              ...
              <p className="text-white/60">
                Post Raghunathpur, District Hooghly
              </p>
              <a
                href="https://maps.google.com/maps?q=Makhla+Uttarpara+Hooghly+West+Bengal"
                target="_blank"
                rel="noreferrer"
                className="inline-block mt-4 text-sm font-bold text-white bg-white/15 hover:bg-white/25 px-5 py-2 rounded-xl transition-all"
              >
                Open in Google Maps →
              </a>
            </div>
